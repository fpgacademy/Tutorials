...
\newcommand{\PDFTitle}{Using the Timing Analyzer}
...
%%%%%%%%%%%%%%%%%%%%%%%%%
% Add title
\newcommand{\doctitle}{Using the \\ Timing Analyzer}
\newcommand{\dochead}{Using the Timing Analyzer}
...
This tutorial provides an introduction to the Timing Analyzer. It demonstrates how to 
set up timing constraints and obtain timing information for a logic circuit.

The reader is expected to have a basic understanding of the Verilog hardware description 
...
\item Using the Timing Analyzer
