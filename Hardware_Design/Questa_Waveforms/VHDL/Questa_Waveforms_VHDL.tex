...
\newcommand{\PDFTitle}{Using the Questa Intel FPGA Simulator by Drawing Waveforms}
...
%%%%%%%%%%%%%%%%%%%%%%%%%
% Add title
\newcommand{\doctitle}{Using the Questa Intel FPGA \\ Simulator by Drawing Waveforms}
\newcommand{\dochead}{Using the Questa Intel FPGA Simulator}
...
in the {\it Questa Intel FPGA} simulator. We assume that you are using 
{\it Questa Intel Starter FPGA Edition-64 2021.2}. This software can 
...
This tutorial is intended for introductory use of Questa by students who are just
...
{\it Using the Questa Intel FPGA Simulator with VHDL Testbenches}.
...
\begin{figure}[H]
   \begin{center}
      \includegraphics[scale=0.7]{figures/figure2.png}
...
\begin{figure}[H]
   \begin{center}
      \includegraphics[scale=0.7]{figures/figure7.png}
...
\begin{figure}[H]
   \begin{center}
      \includegraphics[scale=0.7]{figures/figure12.png}
...
\begin{figure}[H]
   \begin{center}
      \includegraphics[scale=0.7]{figures/figure20.png}
...
\begin{figure}[H]
   \begin{center}
      \includegraphics[scale=0.7]{figures/figure21.png}
...
\begin{figure}[H]
   \begin{center}
      \includegraphics[scale=0.7]{figures/figure24.png}
...
In the folder {\it Questa\_Tutorial$\backslash$Mux\_4bit} enter the VHDL code for 
...
For the previous Questa project described in this tutorial we employed features of the \texttt{Wave} window
