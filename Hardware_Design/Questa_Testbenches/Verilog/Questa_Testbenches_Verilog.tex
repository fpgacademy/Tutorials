...
\newcommand{\PDFTitle}{Using the Questa Intel FPGA Simulator with Verilog Testbenches}
...
%%%%%%%%%%%%%%%%%%%%%%%%%
% Add title
\newcommand{\doctitle}{Using the Questa Intel FPGA \\ Simulator with Verilog Testbenches}
\newcommand{\dochead}{Using the Questa Intel FPGA Simulator with Verilog Testbenches}
