...
in the {\it ModelSim FPGA} simulator. We assume that you are using the
{\it ModelSim FPGA Starter Edition} that accompanies Quartus Prime version 21.1. This software can 
be downloaded and installed from the {\it Download Center for Intel (Altera) FPGAs}. In this
...
{\it Using the ModelSim FPGA Simulator with VHDL Testbenches}.
