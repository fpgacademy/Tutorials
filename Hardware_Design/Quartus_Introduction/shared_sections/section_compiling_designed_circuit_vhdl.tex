...
clicking on the toolbar icon \includegraphics[scale=1]{figures/icon5.png} that looks
...
Compile the erroneous design file by clicking on the \includegraphics[scale=1]{figures/icon5.png} icon.
