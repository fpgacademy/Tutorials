...
\newcommand{\PDFTitle}{Using the ModelSim-Intel FPGA Simulator with Verilog Testbenches}
...
%%%%%%%%%%%%%%%%%%%%%%%%%
% Add title
\newcommand{\doctitle}{Using the ModelSim-Intel FPGA \\ Simulator with Verilog Testbenches}
\newcommand{\dochead}{Using the ModelSim-Intel FPGA Simulator with Verilog Testbenches}
...
{\it ModelSim-Intel FPGA} simulator. We assume 
that you are using {\it ModelSim-Intel FPGA Starter Edition version 18.0}. This software can 
