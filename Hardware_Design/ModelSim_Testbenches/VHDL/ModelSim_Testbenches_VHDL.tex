...
\newcommand{\PDFTitle}{Using the ModelSim FPGA Simulator with VHDL Testbenches}
...
%%%%%%%%%%%%%%%%%%%%%%%%%
% Add title
\newcommand{\doctitle}{Using the ModelSim FPGA \\ Simulator with VHDL Testbenches}
\newcommand{\dochead}{Using the ModelSim FPGA Simulator with VHDL Testbenches}
