...
\newcommand{\PDFTitle}{Using the ModelSim-Intel FPGA Simulator with VHDL Testbenches}
...
%%%%%%%%%%%%%%%%%%%%%%%%%
% Add title
\newcommand{\doctitle}{Using the ModelSim-Intel FPGA \\ Simulator with VHDL Testbenches}
\newcommand{\dochead}{Using the ModelSim-Intel FPGA Simulator with VHDL Testbenches}
