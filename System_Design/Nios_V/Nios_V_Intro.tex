...
{\it mtimecmp}. Also, this action resets the timer for its next timeout. Instead of
resetting {\it mtime} to zero, an equivalent way
of handling the timer would be to add the {\it onesecond} value to the current {\it mtime}
value, and store this sum into {\it mtimecmp}.
However, this would be more complex and wouldn't have any advantage in this
usage case over our simpler approach of resetting {\it mtime}. 
