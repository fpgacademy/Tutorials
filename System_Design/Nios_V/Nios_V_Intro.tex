...
\>{\sf slti} \>{\sf rd, rs1, imm} \>(set if less than immediate)\\
\>{\sf sltiu} \>{\sf rd, rs1, uimm} \>(set if less than immediate unsigned)
\end{ctabbing}
...
\begin{figure}[H]
\lstinputlisting[style=defaultNiosVStyle]{Code/dot_product.s}
