...
# *********************************************************************************
# JCJB:  This is a duplicate of mSGDMA read master with enhancements to synchronize
#        transfer responses to the returning of bus responses.  Unaligned accesses
#        have been disabled since the changes for DCP will most likely break unaligned
#        accesses (DCP doesn't need this).
# *********************************************************************************
...
set_module_property NAME dcp_dma_read_master
...
set_module_property DISPLAY_NAME "DCP mSGDMA Read Master"
...
#set_module_assignment embeddedsw.dts.name "msgdma-read-master"
#set_module_assignment embeddedsw.dts.compatible "ALTR,msgdma-read-master-1.0"
# | 
# +-----------------------------------
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL dcp_read_master
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file dcp_read_master.v VERILOG PATH dcp_read_master.v TOP_LEVEL_FILE
add_fileset_file dcp_MM_to_ST_Adapter.v VERILOG PATH dcp_MM_to_ST_Adapter.v 
add_fileset_file dcp_read_burst_control.v VERILOG PATH dcp_read_burst_control.v
add_fileset_file dcp_read_master_response_tracking.v VERILOG PATH dcp_read_master_response_tracking.v

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL dcp_read_master
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file dcp_read_master.v VERILOG PATH dcp_read_master.v
add_fileset_file dcp_MM_to_ST_Adapter.v VERILOG PATH dcp_MM_to_ST_Adapter.v 
add_fileset_file dcp_read_burst_control.v VERILOG PATH dcp_read_burst_control.v
add_fileset_file dcp_read_master_response_tracking.v VERILOG PATH dcp_read_master_response_tracking.v

add_fileset SIM_VHDL SIM_VHDL "" ""
set_fileset_property SIM_VHDL TOP_LEVEL dcp_read_master
...
# removing unaligned access option since changes to support multiple outstanding transfers will break unaligned accesses
...
set_parameter_property AUTO_ADDRESS_WIDTH SYSTEM_INFO {ADDRESS_WIDTH Data_Read_Master}
...
add_interface_port Data_Source src_data data Output DATA_WIDTH
add_interface_port Data_Source src_valid valid Output 1
add_interface_port Data_Source src_ready ready Input 1
add_interface_port Data_Source src_sop startofpacket Output 1
add_interface_port Data_Source src_eop endofpacket Output 1
add_interface_port Data_Source src_empty empty Output NUMBER_OF_SYMBOLS_LOG2
add_interface_port Data_Source src_error error Output ERROR_WIDTH
add_interface_port Data_Source src_channel channel Output CHANNEL_WIDTH
# | 
# +-----------------------------------
...
proc elaborate_me {}  {
  ...
  set_port_property src_data WIDTH_EXPR [get_parameter_value DATA_WIDTH]
  set_port_property src_error WIDTH_EXPR [get_parameter_value ERROR_WIDTH]
  set_port_property src_channel WIDTH_EXPR [get_parameter_value CHANNEL_WIDTH]
  ...
  if { [get_parameter_value DATA_WIDTH] == 8 }  {
    set_port_property src_empty WIDTH_EXPR 1
  } else {
    set_port_property src_empty WIDTH_EXPR [get_parameter_value NUMBER_OF_SYMBOLS_LOG2]
  }
  ...
  set_port_property master_readdata WIDTH_EXPR [get_parameter_value DATA_WIDTH]
